    ...
    <div class="row">
        <div class="col-lg-5">
            ...
            @foreach ($spot->infos as $info)
                <a href="/admin/tourist_info/{{$info->spot_id}}/{{$info->language}}" class="btn btn-success">{{$info->language}}</a>    
            @endforeach
            <a href="/admin/tourist_info/add_new/{{$spot->id}}" class="btn btn-primary">Add Language</a>
        </div>
        <div class="col-lg-7">
            <h3>Edit Info</h3>
